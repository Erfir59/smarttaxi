...
<head>
    <meta charset="UTF-8">
    <title>Profil Admin - A4 Taxi</title>
    ...
    <div class="layout">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="admin-profile.php" class="nav-link active">
        ...
        <main class="main-area">
            <header class="page-header">
                ...
                <p>Bonjour, <?= htmlspecialchars($admin['prenom'] ?? '') ?> • <?= date('d M Y H:i') ?></p>
                <a href="dashboard_admin.php" class="btn-secondary"><i class="fas fa-arrow-left"></i> Retour Dashboard</a>
            </header>
            ...
            <div class="card">
                ...
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="nom" value="<?= htmlspecialchars($admin['nom'].' '.$admin['prenom']) ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Téléphone</label>
                        <input type="tel" name="telephone" value="<?= htmlspecialchars($admin['telephone']) ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" value="<?= htmlspecialchars($admin['email']) ?>" readonly style="background: #f8f9fa;">
                    </div>
